...
SRC=TROLGraphics/shader.cpp TROLGraphics/glutils.cpp TROLGraphics/textrenderer.cpp TROLGraphics/Data/model.cpp TROLGraphics/Managers/modelmanager.cpp TROLGraphics/Managers/texturemanager.cpp TROLGraphics/Managers/shadermanager.cpp TROLConsole/console.cpp TROLGraphics/camera.cpp TROLLogic/engine.cpp TROLLogic/entity.cpp root.cpp TROLLogic/inputhandler.cpp TROLGraphics/meshrender.cpp TROLGraphics/meshexplode.cpp TROLGraphics/rendermanager.cpp TROLGraphics/skybox.cpp
