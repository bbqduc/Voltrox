...
SRC=TROLGraphics/shader.cpp TROLGraphics/glutils.cpp TROLGraphics/Voxel/shapes.cpp TROLGraphics/textrenderer.cpp TROLGraphics/Data/model.cpp TROLGraphics/renderer.cpp TROLGraphics/Managers/modelmanager.cpp TROLGraphics/Managers/texturemanager.cpp TROLGraphics/Managers/shadermanager.cpp TROLConsole/console.cpp TROLGraphics/camera.cpp TROLLogic/engine.cpp
